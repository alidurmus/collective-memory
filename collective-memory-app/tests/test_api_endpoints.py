...
class TestAPIEndpoints:
    ...
    def test_search_endpoint(self):
        ...
        # Basic search
        search_data = {"query": "test", "type": "basic", "max_results": 10}
    ...
    def test_search_export_markdown(self):
        ...
        search_data = {"query": "test", "type": "basic", "max_results": 5}

        response = requests.post(
            f"{BASE_URL}/search/export",
    ...
    def test_search_export_text(self):
        ...
        search_data = {"query": "test", "type": "basic", "max_results": 3}
    ...
    def test_config_update(self):
        ...
        config_data = {
            "search_settings": {"semantic_threshold": 0.7, "max_results": 20}
        }
...
class TestPerformanceMetrics:
    ...
    def test_search_response_time(self):
        ...
        search_data = {"query": "performance test", "type": "basic", "max_results": 10}
