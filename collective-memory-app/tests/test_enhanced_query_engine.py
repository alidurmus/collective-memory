...
class TestEnhancedQueryEngine:
    ...
    def test_convert_to_enhanced_result(self, enhanced_query_engine):
        ...
        enhanced_result = enhanced_query_engine._convert_to_enhanced_result(
            basic_result
        )
    ...
    def test_calculate_content_quality(self, enhanced_query_engine):
        ...
        score = enhanced_query_engine._calculate_content_quality_impl(
            high_quality_content
        )
    ...
    def test_calculate_context_relevance(self, enhanced_query_engine):
        ...
        score = enhanced_query_engine._calculate_context_relevance(
            relevant_result, query
        )
    ...
    def test_search_without_ml(self, enhanced_query_engine):
        ...
        with patch.object(
            enhanced_query_engine, "search", wraps=enhanced_query_engine.search
        ) as mock_search:
            with patch.object(
                enhanced_query_engine.__class__.__bases__[0], "search"
            ) as mock_parent_search:
