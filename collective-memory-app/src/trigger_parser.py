...
class TriggerParser:
    ...
    def validate_trigger_syntax(self, trigger_text: str) -> Dict[str, Any]:
        ...
        if any(char in trigger_text for char in ['<', '>', '|', '&']):
            ...
            validation_result['suggestions'].append("Özel karakterleri kullanmaktan kaçının")
    ...
    def extract_request_keywords(self, request_text: str) -> List[str]:
        ...
        stopwords = {
            ...
            'ta', 'te', 'dan', 'den', 'tan', 'ten', 'a', 'e', 'i', 'in', 'on',
            'and', 'or', 'with', 'for', 'a', 'an', 'the', 'is', 'are', 'was',
    ...
    def suggest_similar_requests(self, current_request: str, previous_requests: List[str]) -> List[str]:
