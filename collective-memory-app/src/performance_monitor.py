...
class SystemHealthMonitor:
    ...
    def __init__(self, data_path: Optional[str] = None):
        ...
        self.metrics_file = (
            self.data_path / ".collective-memory" / "system_metrics.json"
        )
    ...
    def get_metrics_summary(self, hours: int = 24) -> Dict[str, Any]:
        ...
        avg_response_time = sum(m.api_response_time_avg for m in recent_app) / len(
            recent_app
        )
        ...
        return {
            ...
            "cpu_usage": {"average": round(avg_cpu, 1), "maximum": round(max_cpu, 1)},
            "memory_usage": {
            ...
            "system_stability": (
                "stable" if max_cpu < 90 and max_memory < 90 else "unstable"
            ),
        }
