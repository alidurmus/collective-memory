...
class QueryBuilder:
    ...
    def build_query(self, context_data: Dict[str, Any], template_type: str = 'structured_prompt') -> str:
    ...
    def _build_structured_prompt(self, context_data: Dict[str, Any]) -> str:
        ...
        query_parts.append(f"**Ana İstek:** {context_data.get('user_request', 'Genel bağlam')}")
        query_parts.append("")
    ...
    def _build_context_aware_prompt(self, context_data: Dict[str, Any]) -> str:
        ...
        query_parts.append(f"**Request:** {context_data.get('user_request', 'General context')}")
        query_parts.append("")
