...
class PerformanceOptimizer:
    def __init__(self, project_root: str = None):
        ...
        self.db_path = (
            self.app_root / ".collective-memory" / "database" / "app_database.db"
        )
        self.report_path = (
            self.project_root
            / "context-engineering"
    ...
    def _calculate_performance_score(self):
        ...
        memory_percent = self.optimization_results["system_info"][
    ...
    def _generate_markdown_summary(self):
        ...
        with open(summary_path, "w", encoding="utf-8") as f:
            ...
            f.write(
                f"**Performance Score:** {self.optimization_results['performance_score']}/100\n\n"
            )
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Collective Memory Performance Optimizer"
    )
